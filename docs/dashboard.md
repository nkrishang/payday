...
gated deposit request before its verification completed. The address is not
...
overpayment remainder on a settled deposit request, the full balance of a returned one,
