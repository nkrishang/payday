...
use gum_core::rfc3339;
use gum_ledger::{AccountId, IssueApiKeyError};
use rand::RngCore;
...
fn account_response(metadata: gum_ledger::ApiKeyMetadata) -> AccountResponse {
    AccountResponse {
        account_id: gum_core::AccountId(metadata.account_id).to_string(),
