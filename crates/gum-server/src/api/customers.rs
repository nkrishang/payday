...
use gum_core::{CustomerId, rfc3339};
use gum_ledger::{AccountId, CreateCustomerInput, DbCustomer};
...
impl From<Vec<gum_ledger::CustomerCurrencyStats>> for CustomerStats {
    fn from(rows: Vec<gum_ledger::CustomerCurrencyStats>) -> Self {
        Self {
