...
impl WebhookRepository {
    ...
    pub async fn test_event(
        ...
        let payload = serde_json::json!({"version":"2026-08-01","id":gum_core::WebhookEventId(event).to_string(),"type":"webhook.test","occurred_at":gum_core::rfc3339(Utc::now()),"data":{"test":true}});
