...
pub use gum_core::ExpectedDeployment;
use gum_core::{DeploymentError, ObservedDeployment, check_deployment};
...
fn chain_error(error: crate::ChainError) -> DeploymentError {
    DeploymentError::Rpc {
...
mod tests {
    use super::*;
    use crate::mock::{MockChain, mock_code_hash};
