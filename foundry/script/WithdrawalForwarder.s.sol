...
contract WithdrawalForwarderScript is Script {
    ...
    function run() public {
        ...
        console.log("PAYDAY_WITHDRAWAL_FORWARDER_ADDRESS=%s", vm.toString(address(forwarder)));
        console.log("PAYDAY_WITHDRAWAL_FORWARDER_CODE_HASH=%s", vm.toString(address(forwarder).codehash));
    }
}
