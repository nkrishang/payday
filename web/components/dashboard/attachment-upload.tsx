...
export function AttachmentUpload({
  ...
  if (state.status === "pending_upload" || state.status === "scanning") {
    return (
      <div
        role="status"
        className="flex min-w-0 items-center gap-3 rounded-[8px] border border-line bg-raised px-3.5 py-3 text-[13px]"
      >
  ...
  if (state.status === "ready") {
    ...
    return (
      <div className="flex min-w-0 items-center gap-3 rounded-[8px] border border-line bg-raised px-3.5 py-3 text-[13px]">
